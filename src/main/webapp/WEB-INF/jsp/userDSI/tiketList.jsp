...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        jQuery("#solicitari").jqGrid({
            ...
            colModel: [
                ...
                },
                {
                    ...
                    formatter: function(cellvalue, options, rowObject) {
                        ...
                        return "<a href=\"${contextPath}/tiket/userDSI/view?id="+rowObject['id']+"\" style=\" margin-left:14px;\"><img src=\"<c:url value="/resources/img/detail-icon.png" />\" title=\"detalii\" ></a>";
                    }
                }
            ],
            ...
            */
            ondblClickRow: function(rowid, iRow, iCol, e) {
                ...
                window.location = "${contextPath}/tiket/userDSI/view?id=" + rowid;
            }
        }
        );
        ...
        function initGrid(){
            ...
            $("#solicitari").setGridParam({datatype: 'json', url: '${contextPath}/tiket/userDSI/gridlist',page:page,sortname:sidx,sortorder:sord,rows:rows,rowNum:rows,postData: { filters:filters }});
            //$("#solicitari")[0].triggerToolbar();
